					...
					<ul id="eventListArea">
							...
							<div class="pro_module">
								...
								<div class="txt_wrap">
									<a href="" class="conts">
										...
										<div class="tit_info">
											<span class="tit mt_elps">[쿡킷]3월 돌밥돌밥 해결사 쿡킷!</span>
										</div>
									</a>
								</div>
							</div>
							...
							<div class="pro_module">
								...
								<div class="txt_wrap">
									<a href="" class="conts">
										...
										<div class="tit_info">
											<span class="tit mt_elps">[3월]힘내라! 대한민국! 프로모션</span>
										</div>
									</a>
								</div>
							</div>
							...
							<div class="pro_module">
								...
								<div class="txt_wrap">
									<a href="" class="conts">
										<div class="prd_flag_wrap">
											<span class="flag cate">EVENT</span>
											<span class="date">2020.03.04 ~ 2020.12.31</span>
										</div>
										<div class="tit_info">
											<span class="tit mt_elps">스탬프 쾅!쾅! 혜택이 팡!팡!</span>
										</div>
									</a>
								</div>
							</div>
							...
							<div class="pro_module">
								...
								<div class="txt_wrap">
									<a href="" class="conts">
										<div class="prd_flag_wrap">
											<span class="flag cate">EVENT</span>
											<span class="date">2019.06.24 ~ 2020.06.30</span>
										</div>
										<div class="tit_info">
											<span class="tit mt_elps">첫 구매시 무료배송 & 최대 만원 할인쿠폰 혜택</span>
										</div>
									</a>
								</div>
							</div>
						...
						<li>
							<div class="pro_module">
								<div class="img_wrap">
									<a href="" class="link_more">
										<img src="images/event/event5.jpg">
										<span class="dim"></span>
									</a>
								</div>
								<div class="txt_wrap">
									<a href="" class="conts">
										<div class="prd_flag_wrap">
											<span class="flag cate">EVENT</span>
											<span class="date">2020.03.01 ~ 2020.03.31</span>
										</div>
										<div class="tit_info">
											<span class="tit mt_elps">쿡킷 💳 이달의 카드사 청구할인</span>
										</div>
									</a>
								</div>
							</div>
