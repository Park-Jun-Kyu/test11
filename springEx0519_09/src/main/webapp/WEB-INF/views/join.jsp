				...
				<div id="sectionform1">
					<table id="inputTable1">
						...
						<tr>
							<th class="th"><img alt="빨간별표식" src="images/point_rs.png"
								class="star">비밀번호</th>
							<td><input type="password" id="psw1"><br>
								<p class="notice">
						...
						<tr>
							<th class="th"><img alt="빨간별표식" src="images/point_rs.png"
								class="star">주소</th>
							<td><input type="text" id="adress1">&nbsp;&nbsp;-&nbsp;&nbsp;<input
								type="text" id="adress2">
								<button id="check1">우편번호</button> <br> <input type="text"
								id="adress3"> <br> <input type="text" id="adress4"></td>
						</tr>
						<!--7행  -->
						<tr>
							<th class="th"><img alt="빨간별표식" src="images/point_rs.png"
								class="star">휴대전화</th>
							<td><input type="text" id="phone1">&nbsp;&nbsp;-&nbsp;&nbsp;<input
								type="text" id="phone2">&nbsp;&nbsp;-&nbsp;&nbsp;<input
								type="text" id="phone3"></td>
						</tr>
						<!--8행  -->
						<tr>
							<th class="th"><img alt="빨간별표식" src="images/point_rs.png"
							...
							<td><select id="year">
									...
									<option>30</option>
									<option>31</option>
							</select>일&nbsp;&nbsp; <input type="radio" name="birth" id="solar"
								value="solar"><span class=notice1>양력</span> &nbsp;&nbsp; <input
								type="radio" name="birth" id="lunar" value="solar"><span
					...
					<div id="buttondiv">
						...
						<button id="formCancel" class="button">취소하기</button>
						<button id="formSubmit" class="button">가입하기</button>
					</div>
				</div>
